...
As of the repositioning sprint, this MVP is the public Hakan Leonardo business/services website. It must not expand into Leonardo Tales Core, Dev, Science, agent OS, or software factory work inside this repository.
...
- Leonardo Tales Core/Dev/Science implementation.
- Agent OS or software factory implementation.
