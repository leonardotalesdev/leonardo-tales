...
# Hakan Leonardo Agent Rules

Repository: `leonardotalesdev/leonardo-tales`

Positioning: **Hakan Leonardo — Yapay Zekâ Sistemleri ve İş Ajanları**

This repository is the public Hakan Leonardo business/services website. It is not the final Leonardo Tales Core, Dev, Science, agent OS, or software factory project. Do not start building those larger systems in this repo; they should be created later in clean, separate repositories.
...
Preserve the current premium, minimal, terminal-like AI systems language:

- Dark grid background.
- Amber/gold and green system colors.
- Text-based Hakan Leonardo wordmark.
...
- Do not expand this repository into Leonardo Tales Core, Dev, Science, agent OS, or software factory work.
